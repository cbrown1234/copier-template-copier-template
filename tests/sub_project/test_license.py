...
class TestLicense:
    def test_default_mit_license(self, sub_project: Path) -> None:
    ...
    def test_apache_license(self, sub_project: Path) -> None:
        license_file = sub_project / 'LICENSE'
        assert license_file.exists()
    ...
    def test_unlicense(self, sub_project: Path) -> None:
        license_file = sub_project / 'LICENSE'
        assert license_file.exists()
    ...
    def test_no_license(self, sub_project: Path) -> None:
        license_file = sub_project / 'LICENSE'
